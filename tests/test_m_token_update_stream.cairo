...
func add_stream{
    ...
    %}
        ...
        Im_token.start_stream(contract_address=contract_address, recipient=RECIPIENT_ADDRESS, 
                                amount_per_second=amount_per_second, deposit_amount=deposit_amount)
...
func test_update_stream{
    ...
    let outflowId = 0
    Im_token.update_stream(contract_address=contract_address,outflow_id=outflowId, amount_per_second=amount_updated)
